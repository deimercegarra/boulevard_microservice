...
public class DatosTest {
    ...
    public static final OrderModel ORDER_MODEL_001 = new OrderModel(1L, 2L, new Date(), Constants.ORDER_STATUS_PENDING, 2L, RESTAURANT_MODEL_001);
    ...
    public static final OrderModel ORDER_MODEL_005 = new OrderModel(5L, 2L, new Date(), Constants.ORDER_STATUS_PENDING, 2L, RESTAURANT_MODEL_001);
